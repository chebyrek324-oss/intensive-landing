    ...
    blocks: [
      {
        ...
        bullets: [
          ...
          'Из РФ официально недоступен: нужен VPN + зарубежная карта (или оплата через посредников). Из КЗ, Грузии, Армении, Турции работает напрямую',
      ...
      },
      {
        ...
        bullets: [
          'AntiGravity (Google) - вышел из preview в июне 2026, мультиагентные задачи, из РФ через VPN',
