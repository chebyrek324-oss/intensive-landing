...
const items = [
  {
    ...
    a: 'Три коротких урока. Можно пройти за один заход или растянуть - прогресс сохранится в браузере.',
  },
  {
  ...
  },
  {
    ...
    a: 'Понимание куда двигаться, два бонуса (50 ниш без конкуренции + чек-лист «$500 за 7 дней»), приглашение в закрытый канал с кейсами учеников и встреча с командой с рекомендацией по развитию.',
  },
];
